                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <a type="button" class="btn btn-danger" href="{{route('courrier.delete',$courrier->id)}}">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal fade" id="edit{{$courrier->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                    <a type="button" class="btn btn-primary" href="{{route('courrier.update',$courrier->id)}}">Edit</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
